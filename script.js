...
this.document.querySelector(".aboutMe").style.backgroundColor =
  "rgba(233, 84, 32, 0.25)";
  ...
  switch (true) {
    case scrollPosition == originalPosition:
      ...
      this.document.querySelector(".aboutMe").style.backgroundColor =
        "rgba(233, 84, 32, 0.25)";
      break;
    case scrollPosition >= originalPosition + viewportHeight &&
      scrollPosition < viewportHeight * 2:
      listItems.forEach((element) => {
        element.style.backgroundColor = "";
      });
      this.document.querySelector(".skills").style.backgroundColor =
        "rgba(233, 84, 32, 0.25)";
      break;
    case scrollPosition >= originalPosition + viewportHeight * 2 &&
      scrollPosition < viewportHeight * 3:
      listItems.forEach((element) => {
        element.style.backgroundColor = "";
      });
      this.document.querySelector(".resume").style.backgroundColor =
        "rgba(233, 84, 32, 0.25)";
      break;
    case scrollPosition >= originalPosition + viewportHeight * 3 &&
      scrollPosition < viewportHeight * 4:
      listItems.forEach((element) => {
        element.style.backgroundColor = "";
      });
      this.document.querySelector(".projects").style.backgroundColor =
        "rgba(233, 84, 32, 0.25)";
      break;
    case scrollPosition >= originalPosition + viewportHeight * 4 &&
      scrollPosition < viewportHeight * 5:
      listItems.forEach((element) => {
        element.style.backgroundColor = "";
      });
      this.document.querySelector(".contactMe").style.backgroundColor =
        "rgba(233, 84, 32, 0.25)";
      break;
  }
});
